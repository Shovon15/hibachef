    ...
    <ContentContainer className={className}>
      ...
      <div className="bg-[#F2F2F2] rounded-3xl p-6 flex flex-col lg:flex-row justify-between items-center mt-10 lg:mt-16 gap-8">
        ...
        <div className="w-full lg:w-fit">
          <NavLink
            href={"#"}
            className=" block px-7 py-4 bg-[#EE1F26] rounded-full font-graphikTrial font-medium text-base text-white uppercase border border-[#EE1F26] hover:bg-transparent hover:text-[#EE1F26] transition-all deuration-300  text-center"
          >
            View Google reviews
          </NavLink>
        </div>
